...
from nerfstudio.model_components.renderers import AccumulationRenderer, DepthRenderer, NormalsRenderer, RGBRenderer, BinaryRenderer
...
class NerfactoModel(Model):
    ...
    def populate_modules(self):
        ...
        # renderers
        #修改前self.renderer_rgb = RGBRenderer(background_color=self.config.background_color)
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        #修改前rgb = self.renderer_rgb(rgb=field_outputs[FieldHeadNames.RGB], weights=weights)
    ...
    def get_image_metrics_and_images(
        ...
        predicted_binary = outputs["binary"]  # Blended with background (black if random background)
